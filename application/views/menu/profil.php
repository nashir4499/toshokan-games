<div class="container isi">
    ...
    <div class="row">
        ...
        <div class="col-md-5">
            ...
            <a href="" class=" float-right tampilModalUbah" data-toggle="modal" data-target="#formUdanE" data-id="<?= $user['id']; ?>"><button>Ubah Nama dan Email</button></a>
        </div>
    </div>
    <hr>
...
<div class="modal fade" id="formPass" tabindex="-1" role="dialog" aria-labelledby="formPassLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= base_url('menu/ubahProfil') ?>" method="post">
                    <input type="hidden" name="id" value="<?= $user['id']; ?>">
                    <div class="form-group">
